<html class="a-transition a-transform a-opacity a-border-image a-border-radius a-box-shadow a-text-stroke a-text-shadow a-touch-scrolling a-transform3d a-gradients a-local-storage a-textarea-placeholder a-input-placeholder a-autofocus a-webworker a-history a-geolocation a-drag-drop a-svg a-canvas a-video a-audio a-js a-ws" data-aui-build-date=3.19.3-2019-06-04><head><meta charset=utf-8><meta http-equiv=X-UA-Compatible content="IE=edge"><meta name=viewport content="width=device-width,initial-scale=1"><title>Zoqolo</title><link rel=stylesheet href=/assets/css/css.css><link rel=stylesheet href=/assets/css/materialdesignicons.min.css><link rel=stylesheet href=/assest/main2.css><link id=effect rel=stylesheet type=text/css media=all href=/WebSlide/fade-up.css><link rel=stylesheet type=text/css media=all href=/WebSlide/webslidemenu.css><link href="https://fonts.googleapis.com/css?family=Roboto" rel=stylesheet><link rel=stylesheet href=/assets/plugins/OwlCarousel/dist/assets/owl.carousel.css><link rel=stylesheet href=/assets/plugins/fontawesome-free-5.9.0-web/css/all.css><link rel=stylesheet href=https://cdnjs.cloudflare.com/ajax/libs/rateYo/2.3.4/jquery.rateyo.min.css><link rel=stylesheet href=/owl/owl.carousel.min.css><link rel=stylesheet href=/owl/owl.theme.default.min.css><link rel=stylesheet href=/js/rangeslider.css><link rel=stylesheet type=text/css href=/css/mystyle.css><link href=/css/mdb.min.css rel=stylesheet><link rel=stylesheet href=/assets/dist/css/style.css><style type=text/css>::-webkit-scrollbar {
            width: 7px;
        }
        ...
        .body{
            background: #f3b8af;
        }</style><link rel="shortcut icon" href=/assetss/img/favicon.png><link rel=stylesheet href=/assetss/css/fontawesome-all.min.css><link rel=stylesheet href=/assetss/css/nice-select.css><link rel=stylesheet href=/assetss/css/default.css><link rel=stylesheet href=/assetss/css/style.css><link rel=stylesheet href=/assetss/css/responsive.css><style type=text/css>::-webkit-scrollbar {
            width: 7px;
        }
        ::-webkit-scrollbar-track {
            background: #f1f1f1;
        ...
        ::-webkit-scrollbar-thumb:hover {
            background: #555;
        }</style><link rel=stylesheet href=/admin/css/font-icons/entypo/css/entypo.css><link rel=stylesheet href=/admin/css/font-icons/font-awesome/css/font-awesome.css><link rel=stylesheet href=/admin/css/zoqolo-core.css><link rel=stylesheet href=/admin/css/zoqolo-theme.css><link rel=stylesheet href=/admin/css/zoqolo-forms.css><link rel=stylesheet href=/admin/js/progressBar/jQuery-plugin-progressbar.css><script src=/WebSlide/jquery-3.2.1.min.js.download></script><script src=/WebSlide/bootstrap.min.js.download></script><script src=/WebSlide/webslidemenu.js.download></script><link href=/css/app.520393d7.css rel=preload as=style><link href=/css/chunk-vendors.bdf2c778.css rel=preload as=style><link href=/js/app.9a82fb81.js rel=preload as=script><link href=/js/chunk-vendors.bb7a7774.js rel=preload as=script><link href=/css/chunk-vendors.bdf2c778.css rel=stylesheet><link href=/css/app.520393d7.css rel=stylesheet></head><body><div id=app class=app></div><script src=/js/chunk-vendors.bb7a7774.js></script><script src=/js/app.9a82fb81.js></script></body><script src=/assest/script1.js></script><script>var opts = {
        ...
        window.$Nav && $Nav.declare('configComplete');</script><script>window.$Nav && $Nav.when("data").run(function(data) {
            data({
                    ...
                    "template": {
                        ...
                        "data": {
                            "items": [{
                                ...
                                "panelKey": "hardwarePanel"
                            }, {
                                "text": "Integrated Circuits",
                                "panelKey": "circuitsPanel"
                            }, {
                                "text": "Transistors",
                                "panelKey": "transisPanel"
                            }, {
                                "text": "Power Banks",
                                "panelKey": "PrimeVideoPanel"
                            }, {
                                "text": "Mobile Phones",
                                "panelKey": "PrimeMusicPanel"
                            }, {
                                "text": "Chargers",
                                "dividerBefore": "1",
                                "panelKey": "PhonesAccessoriesPanel"
                            }, {
                                "text": "Hard Drives",
                                "panelKey": "TvApplElecPanel"
                            }, {
                                "text": "Generators",
                                "panelKey": "MensFashionPanel"
                            }, {
                                "text": "Motors",
                                "panelKey": "WomensFashionPanel"
                            }, {
                                "text": "Hand Tools",
                                "panelKey": "HomeKitchenPanel"
                            }, {
                                "text": "Air Conditioners",
                                "panelKey": "BeautyHpcPanel"
                            }, {
                                "text": "Sports, Fitness, Bags, Luggage",
                                "panelKey": "SportsOutdoorsPanel"
                            }, {
                                "text": "Toys, Baby Products, Kids' Fashion",
                                "panelKey": "ToysBabyPanel"
                            }, {
                                "text": "Car, Motorbike, Industrial",
                                "panelKey": "AutomotivePanel"
                            }, {
                                "subtext": "Just launched: Audible",
                                "text": "Books & Audible",
                                "panelKey": "BooksPanel"
                            }, {
                                "text": "Movies, Music & Video Games",
                                "panelKey": "MusicMoviesGamesPanel"
                            }, {
                                "text": "Air Conditioners",
                                "panelKey": "airconditionersPanel"
                            }, {
                                "text": "Flight Tickets",
                                "url": "/flights?_encoding=UTF8&ref_=nav_shopall_sbc_desktop_flights"
                            }, {
                                "text": "Full Store Directory",
                                "decorate": "carat",
                                "url": "/gp/site-directory?ie=UTF8&ref_=nav_shopall_sbc_fullstore",
                                "dividerBefore": "1"
                            }]
                        }
                    }
                ...
                <!-- Vartical menu 2 start -->

                    "circuitsPanel": {
                    "promoID": "nav-sa-gift-cards",
                    "template": {
                        "name": "itemList",
                        "data": {
                            "text": "Integrated Circuits",
            ...
            <!-- Vartical menu 3 start -->

                "transisPanel": {
                    "promoID": "nav-sa-kindle",
                    "template": {
                        "name": "itemList",
                            "data": {
                            "text": "Transistors",
                            "items": [{
                                ...
                                "items": [{
                                    ...
                                    "subtext": "Covers, chargers, sleeves and more",
                                ...
                                "items": [{
                                    ...
                                    "subtext": "With a free 30-day trial",
            ...
            <!-- Vartical menu 6 start -->
                "PhonesAccessoriesPanel": {
                    "promoID": "nav-sa-gift-cards",
                    "template": {
                        "name": "itemList",
                        "data": {
            ...
            <!-- Vartical menu 8 start -->
                "MensFashionPanel": {
                    "promoID": "nav-sa-mens-fashion",
                    "template": {
                        "name": "itemList",
                        "data": {
                            "text": "Generators",
            ...
            <!-- Vartical menu 9 start -->

            "WomensFashionPanel": {
                    "promoID": "nav-sa-womens-fashion",
                    "template": {
                        "name": "itemList",
                            "data": {
                            "text": "Motors",
            ...
            <!-- Vartical menu 10 start -->

                "HomeKitchenPanel": {
                    "promoID": "nav-sa-home-kitchen",
                    "template": {
                        "name": "itemList",
                        "data": {
                            "text": "Hand Tools",
            ...
            <!-- Vartical menu 11 start -->
                "BeautyHpcPanel": {
                    "promoID": "nav-sa-beauty-hpc",
                    "template": {
                        "name": "itemList",
                            "data": {
                            "text": "Air COnditioners",
            ...
            <!-- Vartical menu 15 start -->
            "BooksPanel": {
                    "promoID": "nav-sa-books",
                    "template": {
                        "name": "itemList",
                        "data": {
                            "subtext": "Just launched: Audible",
            ...
            <!-- Vartical menu 16 start -->
            "MusicMoviesGamesPanel": {
                    "promoID": "nav-sa-music-movies-games",
                    "template": {
                        "name": "itemList",
                            "data": {
                            "text": "Movies, Music & Video Games",
            ...
            <!-- Vartical menu 17 start -->
                "airconditionersPanel": {
                    "promoID": "nav-sa-gift-cards",
                    "template": {
                        "name": "itemList",
                        "data": {
                ...
                "templates": {
                    ...
                    "wishlist": "<# jQuery.each(wishlist, function (i, item) { #>  <li class='nav_pop_li'>    <a href='<#=item.url #>' class='nav_a'>      <#=item.name #>    </a>    <div class='nav_tag'>      <!-- TODO this logic should now be in dynamic-wish-list.mi -->      <# if(typeof item.count !='undefined') { #>        <#=          (item.count == 1 ? '{count} item' : '{count} items')            .replace('{count}', item.count)        #>      <# } #>    </div>  </li><# }); #>",
        ...
        });</script><script>window.$Nav && $Nav.declare('config.prefetch', function() {
        ...
        (window.AmazonUIPageJS ? AmazonUIPageJS : P).register('navCF');</script><script src=/assets/dist/js/jquery.vendors.js></script><script src=/assets/dist/js/jquery.project.js></script><script src=/assets/plugins/OwlCarousel/dist/owl.carousel.js></script><script src=https://cdnjs.cloudflare.com/ajax/libs/rateYo/2.3.4/jquery.rateyo.min.js></script><script>(function($){

      $(document).ready(function(){


          $('.drpdn').click(function(){
...
$(function () {
  $(".seller_review").rateYo({
     rating: 4.5,
     readOnly: true,
     ratedFill: "#9d3931",
     starWidth: "30px",
  });
});</script><script>$('.add').click(function () {
    if ($(this).prev().val() < 5) {
...
$('.sub').click(function () {
 ...
 /*$("a[data-selector]").click(function() {
     $("#"+$(this).attr('data-selector')).siblings('.menu_contain_right').hide();
     $("#"+$(this).attr('data-selector')).siblings('.products_info_part').hide();
     $("#"+$(this).attr('data-selector')).siblings('.category_info_part').hide();
     $("#"+$(this).attr('data-selector')).show();
 });*/

 $("a[data-selector]").click(function(){
     var $thisSelect = $(this).attr('data-selector');
     $thisSelect = '#'+$thisSelect;
     $('.category_info_part').hide();
     $($thisSelect).show();
 });</script><script>$(".menu_contain_left_list li a").click(function(){
     $(".menu_contain_left_list li a").removeClass('active');
     $(this).addClass('active');
 });

 $(".list_part li a").click(function(){
     $(".list_part li a").removeClass('active');
     $(this).addClass('active');
 });

 $(".category_left_list li a").click(function(){
     $(".category_left_list li a").removeClass('active');
     $(this).addClass('active');
 });</script><script>$(document).ready(function(e) {
    $(".category_part > a").click(function(){
        $(".category_main_box").slideToggle();
    });

    $(".mobile_menu a").click(function(){
        $(".cart_part").slideToggle();
    });
...
$(".banner_menu_part ul li").hover(function(){
    if($(".category_main_box").is(":visible")){
        $(".category_main_box").slideUp('fast');
    }
})

$(document).click(function(e){
    var container = $(".category_part");
    if(!container.is(e.target) && container.has(e.target).length === 0){
        $(".category_main_box").slideUp();
    }
})</script><script>$(document).ready(function(){
    var container = $(".category_main_box");
    if(!container.is(e.target) && container.has(e.target).length === 0){
        $(".category_main_box").hide();
    }
});

$(".thumb_img img").click(function(){
    var src = $(this).attr('src');
    $(".products_top_img_part img").attr('src',src);
});</script></html>