                ...
                >
                        ...
                        >
                            <Draggable v-for="(data, i) in themeData" :key="i" style="background-color: white;"
                                       :class="selected == i ? `draggable-item-focus drag-${i}` : `drag-${i}`">
            ...
            duplicate() {
                if (this.selected != -1) {
                    ...
                    newData = {
                        ...
                        height: $('.drag-' + this.selected).height(),
                    }
                    this.themeData.splice((this.selected + 1), 0, newData)
                }
                setTimeout(()=> {
                    if (this.resizeHeight < $('#dnd-container').height()) {
                        this.resizeHeight = $('#dnd-container').height()
                    }
                }, 100)
                this.minH = $('#dnd-container').height()
            },
            deleteElement() {
                if (this.selected != -1) {
