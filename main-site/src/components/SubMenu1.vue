<template>
    <li class=""><span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span><span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span><a href="#">Women's Wear &amp; Items</a>
                    ...
                    <div class="col-lg-6 col-md-12 bg4">
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="bx">
                                    <h3>Blog</h3>
                                    <p>Read the latest blogs on topics covering Data Lakes, Compute, and more</p>
                                </div>
                            </div>
