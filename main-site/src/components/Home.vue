<template>
  <li aria-haspopup="true">
    ...
    ><a href="#" class="navtext"
      ><span></span> <span>Home &amp; Furniture</span></a
    >
      ...
      <div class="wsshopwp clearfix" style="height: 400px;">
        <ul class="wstabitem clearfix">
          <li class="wsshoplink-active">
            ...
            ><span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span
            ><a href="#">Women's Wear &amp; Items</a>
            <div
              class="wstitemright clearfix wstitemrightactive"
              style="height: auto;"
            >
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-3 col-md-12">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        <a href="#"
                          >Air Conditioners
                          <span class="wstmenutag greentag">New</span></a
                        >
                      </li>
                      ...
                      <li>
                        ...
                        <span class="wstmenutag orangetag">New</span>
                      </li>
                      <li><a href="#">Washing Machines </a></li>
                  ...
                  <div class="col-lg-3 col-md-12">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        ...
                        <span class="wstmenutag bluetag">Popular</span>
                      </li>
                  ...
                  <div class="col-lg-6 col-md-12 bg4">
                    <div class="row">
                      <div class="col-lg-6 col-md-12">
                        <div class="bx">
                          <h3>Blog</h3>
                          <p>
                            Read the latest blogs on topics covering Data Lakes,
                            Compute, and more
                          </p>
                        </div>
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-12 clearfix">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        <a href="#">Xbox 1 </a>
                        <span class="wstmenutag orangetag">Most Viewed</span>
                      </li>
                  ...
                  <div class="col-lg-3 col-md-12 clearfix">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        <a href="#"
                          >Christian
                          <span class="wstmenutag bluetag">50% off</span></a
                        >
                      </li>
                  ...
                  <div class="col-lg-3 col-md-12 clearfix">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        <a href="#"
                          >Children's Music
                          <span class="wstmenutag redtag">Discounted</span></a
                        >
                      </li>
          ...
          <li class="">
            ...
            <div
              class="wstitemright clearfix kitchenmenuimg"
              style="height: auto;"
            >
              <div class="container-fluid">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-12">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        <a href="#"
                          >Accessories <span class="wstcount">(1145)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Bags &amp; Cases
                          <span class="wstcount">(445)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Binoculars &amp; Scopes
                          <span class="wstcount">(45)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Digital Cameras
                          <span class="wstcount">(845)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Film Photography
                          <span class="wstcount">(245)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Flashes <span class="wstcount">(105)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Lenses <span class="wstcount">(445)</span></a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >Video <span class="wstcount">(145)</span>
                          <span class="wstmenutag bluetag">Popular</span></a
                        >
                      </li>
                    </ul>
                  </div>
                  <div class="col-lg-3 col-md-12">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        ...
                        <span class="wstmenutag orangetag">Hot</span>
                      </li>
                  ...
                  <div class="col-lg-3 col-md-12">
                    <ul class="wstliststy02 clearfix">
                      ...
                      <li>
                        ...
                        <span class="wstmenutag greentag">New</span>
                      </li>
          ...
          <li class="">
            <span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span
            ><span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span
            ><a href="#">Computers &amp; Game</a>
            <div
              class="wstitemright clearfix computermenubg"
              style="height: auto;"
            >
              <div class="wstmegamenucoll01 clearfix">
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 bg6">
                      <div class="row">
                        <div class="col-lg-6 col-md-12">
                          <div class="bx">
                            <h3>Blog</h3>
                            <p>
                              Read the latest blogs on topics covering Data
                              Lakes, Compute, and more
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                          <ul class="wstliststy05 clearfix">
                            ...
                            <li>
                              <a href="#"
                                >Tapes
                                <span class="wstmenutag redtag">Sale</span></a
                              >
                            </li>
