<template>
    <li class=""><span class="wsmenu-click02"><i class="wsmenu-arrow"></i></span><span class="wsmenu-click02">
        ...
        <div class="wstitemright clearfix" style="height: auto;">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 clearfix"><a href="#" class="wstmegamenucolr"><img src="" alt=""></a></div>
                </div>
            </div>
        </div>
    </li>                       
